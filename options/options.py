...
class EvalOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--jpegCompression', type=int, default=100, help="100, 95, 90, ... 20.")
        parser.add_argument('--transformIterations', type=int, default=0, help="0, 1, 2, 3, 4, 5, 6, 8, 9, 10, 11, ...")
